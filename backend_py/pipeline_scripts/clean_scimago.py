...
with open(BACKEND_DIR / "pipeline_cache/journals_scimago_raw.json", "r", encoding="utf-8") as f:
...
with open(BACKEND_DIR / "pipeline_cache/journals_clean.json", "w", encoding="utf-8") as f:
