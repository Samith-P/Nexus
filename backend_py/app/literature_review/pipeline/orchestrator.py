...
from literature_review.pipeline.pdf_parser import PDFParser
from literature_review.pipeline.text_cleaner import TextCleaner
from literature_review.pipeline.section_detector import SectionDetector
from literature_review.pipeline.chunker import TextChunker
from literature_review.pipeline.embedder import Embedder
from literature_review.pipeline.summarizer import Summarizer
from literature_review.pipeline.insight_extractor import InsightExtractor
from literature_review.pipeline.gap_detector import GapDetector
from literature_review.pipeline.translator import TranslationOutputLayer
from literature_review.storage.vector_store import VectorStore
from literature_review.integrations.semantic_scholar import SemanticScholarClient
from literature_review.integrations.crossref import CrossRefClient
from literature_review.models.schemas import (
    PaperAnalysis,
    InsightResult,
    EvidenceSpan,
...
class LiteratureReviewOrchestrator:
    ...
    def __init__(self, use_indicbert: bool = False):
        ...
        if use_indicbert:
            ...
            from literature_review.pipeline.multilingual import IndicBERTEmbedder
